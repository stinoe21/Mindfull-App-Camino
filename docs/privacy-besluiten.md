...
| ~~Wat de analyticspagina toont, en aan wie~~ | **Besloten op 18 september 2026 (Stijn):** alleen totalen, nooit een totaal onder de 10 (ook niet als je het uit een ander totaal kunt terugrekenen), voor medewerkers van MIND met een rol in `admin_users`. Individuele check-ins inzien kan niet en wordt niet gebouwd: er bestaat geen rij per check-in. Paul moet het nog wegen, samen met punt 8 hierboven. |
