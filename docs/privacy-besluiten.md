...
|---|---|---|
| 1 | **Melden dat de collectieve opslag is aangescherpt: totalen per (dag, uurblok, weerbeeld) in plaats van een rij per inzending.** Besloten op 13 augustus 2026, later op dezelfde dag als de bevestiging van de rij-opzet; de aanscherping verving die. De willekeurige unieke code uit de mail van 7 augustus blijft geschrapt. | Dit blijft het zwaarste punt van de zes, niet omdat het een afzwakking is, maar omdat het uurblok en de totalen nieuw voor hem zijn. Een totaal kent geen volgorde en geen geschiedenis, dus het eerdere restrisico van de invoegvolgorde (`ctid` en `xmin`) is vervallen. **Noem het overgebleven venster expliciet**: wie live meekijkt terwijl een totaal ophoogt, kan binnen de logbewaartermijn van het platform alsnog koppelen; de maatregel is beperkte dashboardtoegang. Verzwijg dat niet, het komt in een DPIA toch boven. Wel te melden als aanscherping: sinds 26 augustus 2026 ziet de app alleen afgesloten uurblokken, dus vanuit de app zelf is een inzending niet meer live te zien binnenkomen. |
| 2 | **Antwoord op zijn vraag over de lokale bewaartermijn.** Hij vroeg op 10 augustus letterlijk: "Is er een bewaartermijn gesteld voor deze lokale gegevens?" | Zelfde onderbouwing als punt 1: het is geen losse vraag maar de basis onder zijn conclusie. Let op dat het antwoord een **toezegging** is en geen waarneming, want de app bestaat nog niet en het lijstje met wat er lokaal staat is nog niet af. Zie `datamodel.md`. **Sinds het bericht van 13 augustus bijgekomen op het toestel, en nog niet gemeld:** de bewaarde tips (14 september 2026), het tijdstip bij het weer van vandaag (15 september 2026) en de challenge-voortgang (17 september 2026: afgeronde dagnummers en de kalenderdag van de laatste afronding). Alle drie alleen lokaal, en gewist bij account verwijderen. |
| 3 | **Melden dat er twee slotvelden per gebruiker bijkomen**, `profiles.last_checkin_on` (datum) en, sinds 15 september 2026, `profiles.last_checkin_part` (dagdeel 1 of 2). | Het datumveld is nieuw sinds 11 augustus 2026 en hij kent het niet; het dagdeel kwam erbij op 15 september 2026 (besluit Stijn: inchecken mag vaker per dag, bijdragen maximaal één keer per dagdeel). Ze bevatten geen weerbeeld, geen tijdstip en geen historie, alleen datum en dagdeel van de laatste bijdrage, en ze bestaan om manipulatie van het landelijke beeld te remmen. Dat is privacy-positief, maar het zijn wél gegevens over een gebruiker en daarmee zijn beslissing om te wegen, niet de onze om stil te bouwen. Nog niet gemeld: het dagdeel kwam na de mail van 13 augustus. |
...
| 5 | ~~**De uitdrukkelijke toestemming onder art. 9 AVG.**~~ | **Beantwoord door Paul op 28 augustus 2026.** De toestemming moet vrij, specifiek, ondubbelzinnig, geïnformeerd en (bij bijzondere persoonsgegevens) uitdrukkelijk zijn. Hij leverde de tekst zelf aan: de vraag "Mag MIND jouw gekozen mentale “weerstatus” verwerken voor het anonieme, geaggregeerde Mentale Weerbericht?", een uitlegalinea, en twee opties: "Ja, ik geef expliciete toestemming voor het gebruik van mijn gegevens voor het Mentale Weer." en "Nee, ik geef geen toestemming." Woordelijk overgenomen in `apps/mobile/src/features/profiel/ToestemmingKeuze.tsx`, als expliciete keuze zonder standaardwaarde (de eerdere schakelaar stond standaard aan, en dat is geen vrije toestemming). De uitleg verwijst naar de privacyverklaring; Paul neemt daarin een tekst over de app op met verwerkingen, grondslagen en bewaartermijnen. **Open:** de URL van die privacyverklaring, zodat de verwijzing in de app een link kan worden. **Sinds 17 september 2026 staat de tekst er in gewone taal** (besluit Stijn). Paul schreef bij zijn tekst: "Voel je vrij om aanpassingen te maken als jullie dat beter lijkt." De vraag is nu "Mag MIND jouw weer anoniem meetellen in het mentale weer van Nederland?", het ja "Ja, ik geef toestemming om mijn weer anoniem mee te tellen in het mentale weer van Nederland.", en het nee is ongewijzigd. De uitleg zegt hetzelfde in eenvoudiger woorden, verwijst naar Profiel in plaats van Instellingen, en noemt nu ook dat wat al is meegeteld in het anonieme totaal blijft staan. Het ja noemt nog steeds het woord toestemming en het doel, dus het blijft uitdrukkelijk. **Deze versie moet Paul nog zien**, als antwoord op zijn vraag of de tekst geschikt is; de tekst staat in `ToestemmingKeuze.tsx`. **Ook open, sinds 17 september 2026:** de uitlegalinea staat in de onboarding niet meer voluit op het scherm maar woordelijk achter "Lees de uitleg", direct onder de vraag en vóór de keuze (gelaagde melding, besluit Stijn). Deze vorm moet Paul ook nog zien. |
| 6 | ~~**Grondslag voor de 16+-eis.**~~ | **Beantwoord door Paul op 28 augustus 2026.** Met 16+ als harde eis is de grondslag voor het vragen van de leeftijd de uitvoering van de overeenkomst; een verklaring "ik ben 16 of ouder" volstaat, en zo staat het al in de app. Een leeftijdscategorie uitvragen voor gebruiksinzicht kan, maar alleen op grondslag toestemming, als aparte stap na de verklaring. Dat is een nieuw gegeven over een gebruiker en dus eerst een besluit in `datamodel.md` (veld, bewaartermijn, doel) voordat het gebouwd wordt. |
...
| 8 | **Melden dat de app sinds 18 september 2026 telt wat er gebeurt, als totalen per dag zonder gebruiker**, en vragen of dat onder de uitzondering voor privacyvriendelijke analytics (art. 11.7a Tw) mag aanstaan met een uitknop, of dat het een aparte vraag moet zijn die standaard uit staat. | Dit is een nieuwe verwerking en hij kent hem niet. De vorm is die van het weerbericht (een totaal, geen rij, geen id), maar de inhoud is rijker: welk onderwerp geopend is, welke zelftest gestart, hoe vaak de Hulplijn. Wat hij moet kunnen wegen staat in `datamodel.md`, sectie "Gebruikstotalen": de vaste lijst events, wat er nooit geteld wordt, het slotveld `profiles.last_usage_on`, en onder "Wat de dagtotalen niet oplossen" het restrisico dat een batch meerdere totalen tegelijk bijwerkt. Leg hem ook de drie twijfelgevallen voor (`interest_selected`, `crisis_term_searched`, `selftest_helproute_shown`) en de vraag wat het dashboard mag tonen bij een klein aantal op de Hulplijn. Bouwen gaat door, want het staat achter één schakelaar en omzetten naar opt-in is één regel. |
| 9 | **Melden dat iemand sinds 18 september 2026 zijn weer van vandaag of de quote zelf kan delen**, als afbeelding via het deelvenster van de telefoon (besluit Stijn). | De app deelt zelf niets en stuurt niets naar de server: het beeld wordt op het toestel gemaakt, de gebruiker kiest zelf de app en de mensen, en het tijdelijke bestand wordt daarna weggegooid. Er wordt niets gelogd. Vóór het delen staat er dat het buiten de app om gaat en dat het aan de gebruiker zelf is. Het is wel een nieuw moment waarop een gegeven over iemands gemoedstoestand het toestel verlaat, op eigen initiatief, en dat hoort Paul te weten. Zie `docs/scope.md` en `apps/mobile/src/app/delen.tsx`. |

Wat wij hem daarbij kunnen meesturen als onderbouwing: de uitvoer van `supabase/tests/anonimisering.sql`. Dat script bewijst aan de tabeldefinities dat de collectieve stroom niet herleidbaar kan zijn, in zeven controles: geen kolom die naar een persoon kan wijzen, geen rij per inzending, geen tijd fijner dan een uur, RLS aan op alle tabellen en dicht op de collectieve tabel, geen rechten voor de app-rollen op de totalen, realtime uit, en een vast `search_path` op de functies. Het sluit af met wat het **niet** bewijst, en dat hoort er net zo goed bij. In de mail van 13 augustus is die uitvoer aangeboden; de afspraak is om hem rond 24 augustus na te sturen, zodra de migratie van 13 augustus op dev staat en het script tegen het definitieve schema heeft gedraaid.

> **Tot Paul hierop gereageerd heeft, is zijn oordeel over de DPIA-plicht niet iets om op te leunen.** Bouwen mag doorgaan, want het schema staat, de hoofdlijn is conform de mail van 7 augustus en de anonimisering is zo sterk als hij binnen deze keuze kan zijn. Wat niet mag, is ergens opschrijven of tegen Mind zeggen dat de app niet DPIA-plichtig is: het uurblok, de totalen, de geschrapte code en het slot per dagdeel heeft hij nog niet gewogen.
...
|---|---|
| Leeftijdscategorie uitvragen, ja of nee | De grondslag is sinds 28 augustus 2026 duidelijk (zie punt 6 hierboven): de 16+-verklaring op uitvoering van de overeenkomst, een categorie alleen op toestemming. Of we die categorie überhaupt willen, is een productbesluit van de drie, en dan eerst een veld met bewaartermijn in `datamodel.md`. |
...
| ~~Welke analytics-events we vastleggen~~ | **Besloten op 18 september 2026 (Stijn):** de vaste lijst in `datamodel.md`, sectie "Gebruikstotalen". Een event erbij blijft een expliciete productbeslissing en komt eerst daar te staan. Paul moet het nog wegen, zie punt 8 hierboven. |
...
- **Geen externe analytics-tool.** Ook nu de app sinds 18 september 2026 telt wat er gebeurt: dat loopt via onze eigen Supabase, als totalen zonder gebruiker.
- **Geen pad per gebruiker.** De gebruikstotalen kunnen niet zeggen of dezelfde persoon stap 1 en stap 3 deed, wie wat las, of wat iemand deed na een regendag. Wie dat wil weten heeft een id of een tijdstip nodig, en dat is precies de sleutel die we niet opslaan.
