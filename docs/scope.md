...
- **De MIND Hulplijn** staat als kaart onderaan Home en Profiel, en de pagina zelf is overal via die kaart bereikbaar. Een chipje rechtsboven op elk scherm is op 13 september 2026 geprobeerd en door Stijn afgewezen ("niet mooi"); waar de Hulplijn verder nog zichtbaar wordt, blijft een open ontwerpbesluit in `design-system.md`.
