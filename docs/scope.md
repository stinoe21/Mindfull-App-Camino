...
> **Naam van de app: "Weertje"**, gekozen door Stijn op 17 september 2026 als werktitel voor nu. Eén woord, een verkleinwoord dat bij de toon past, en zonder de merknaam van MIND erin. Het vervangt "Weer MIND" (1 september 2026), dat Stijn bij nader inzien slecht vond. Nog steeds een werktitel: de definitieve naam ligt bij MIND en moet vastliggen voor de eerste inzending, want naam en bundelnummer zijn daarna niet meer te wijzigen. Nog na te gaan: of de naam vrij is in de App Store en op Google Play. Tot die tijd blijft "Mentale Weerbericht" de naam in de documenten en in `app.config.ts`; alleen de locatietekst daar noemt de app bij de naam die de gebruiker ziet.
...
- **De Tips-tab heet Houvast**, net als het scherm en de sectie op Home ("Houvast voor jou"). De actieve tab in de navigatiebalk staat op een zandpil, dezelfde tint als de basiskaart. Het overzicht toont één niveau (Stijn, 13 september 2026): zoeken plus het raster, zonder de rij filterchips erboven. Sinds 14 september 2026 (Stijn, PR #121 en #123) is dat raster de negen **families** (Stress, Somberheid, Angst, Piekeren, Slaap, Energie, Balans, Ontspanning, Grenzen) in plaats van de 27 onderwerpen, jouw voorkeuren voorop; een familie opent een pagina met haar onderwerpen als lijst en de challenge over dat onderwerp, een familie met één onderwerp (Slaap) opent dat onderwerp direct. De gidsen zonder eigen onderwerp staan achter twee ingangen onderaan: "Voor naasten" en "Andere onderwerpen", elk een lijst. Na een check-in begint Houvast met "Bij jouw weer vandaag" (dezelfde funnel als Home), en daaronder staan de tips die iemand bewaard heeft. Bewaren is alleen lokaal, zie `datamodel.md` onder "Bewaarde tips".
...
- **De MIND Hulplijn** staat als kaart onderaan Home en Profiel, en de pagina zelf is overal via die kaart bereikbaar. Een chipje rechtsboven op elk scherm is op 13 september 2026 geprobeerd en door Stijn afgewezen ("niet mooi"); Sinds 14 september 2026 (Stijn, PR #126) staat de kaart ook onder het paneel Verder van elk Houvast-onderwerp en onder elke testuitslag, met de overline "Praten met iemand van MIND": contact met een mens is iets anders dan verder lezen en staat daarom nooit als gewone tekstlink naast een leeslink, alleen als deze kaart. Op Challenges en tijdens de check-in staat hij niet.
...
- **Welke gebruikersdata slaan we op?** Precies vijf tabellen, allemaal in `datamodel.md` met een bewaartermijn per veld: `profiles` (id, laatst actief, de sloten van de laatste check-in en de laatste batch gebruikstotalen), `weather_hourly` (uursaldo per weerbeeld, zonder enige gebruikerscode), `weather_type` (de vijf weerbeelden), en sinds 18 september 2026 `usage_daily` (gebruikstotalen per dag, zonder gebruiker) met de vaste lijst `usage_event`. Meer niet. Een veld dat daar niet staat, bestaat niet.
...
- **Doen we aan analytics?** Ja, sinds 18 september 2026 (besluit Stijn), en alleen als totalen: de app telt wat er gebeurt per dag, event en item, zonder gebruiker, zonder tijdstip en zonder externe tool. MIND ziet daarmee schermweergaven, de trechter van onboarding en check-in, welke content gebruikt wordt, actieve gebruikers per platform, de Hulplijn per kanaal en of het insturen van het weer lukt. De vaste lijst events en wat er nooit geteld wordt staan in `datamodel.md`, sectie "Gebruikstotalen". Het meten kan uit onder Profiel. Elk event erbij blijft een expliciete productbeslissing en geen bijvangst. Tot 18 september stond hier "geen enkel event".
