// Profiel: taal
//
// De interfacetaal (issue #47): systeem, Nederlands of Engels. De inhoud van
// onderwerpen, gidsen en challenges blijft Nederlands, zie docs/scope.md.
...
const teksten: Woordenboek<typeof nl> = {
  nl,
  en: { titel: "Language", uitleg: "Topics, guides and challenges remain in Dutch.", groep: "Interface", systeem: "System", nederlands: "Nederlands", engels: "English" },
};
const LABEL: Record<TaalKeuze, "systeem" | "nederlands" | "engels"> = { systeem: "systeem", nl: "nederlands", en: "engels" };
